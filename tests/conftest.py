...
from src.models import UserModel, AddRequest, DeleteRequest, UpdateRequest, SelectRequest
...
@pytest.fixture
def select_request() -> SelectRequest:
    return SelectRequestFactory.build()
